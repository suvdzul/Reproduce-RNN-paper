...
The final cohort table will include subject id, stay id, admission id, admission year, hours until death as well as mortality label which is one of the classification task.
